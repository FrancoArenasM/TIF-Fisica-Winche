    ...
    \ifnum\value{page}>1
        \AtPageCenter{%
            \begin{tikzpicture}[remember picture, overlay]
                ...
                \node[opacity=0.15, rotate=45] at (-6,-6) {\includegraphics[width=5.0cm]{logo_unsa_watermark.png}};
                \node[opacity=0.15, rotate=45] at (6,6) {\includegraphics[width=5.0cm]{logo_pesquera_watermark.png}};
...
Para validar experimentalmente la dinámica del cable y su impacto en el winche bajo efectos hidrodinámicos, se desarrolló un simulador en Python (\texttt{simulacion\_winche.py}), el cual se encuentra publicado en el repositorio público de GitHub (\url{https://github.com/FrancoArenasM/TIF-Fisica-Winche}) junto con una versión interactiva web para que cualquier usuario pueda descargarlo y ejecutarlo. El simulador integra numéricamente las ecuaciones de movimiento mediante un método de Euler-Cromer en sub-pasos temporales de $\Delta t = \SI{0.005}{s}$ para asegurar estabilidad matemática.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{prueba1_mar_calma.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{prueba2_corriente_1_5.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{prueba3_carga_maxima.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{prueba4_alta_velocidad.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{prueba5_motor_sobrecarga.png}
