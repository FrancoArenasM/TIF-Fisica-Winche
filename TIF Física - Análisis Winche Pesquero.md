...
ESCUELA PROFESIONAL DE ENFERMERÍA E INGENIERÍA PESQUERA
...
| Presentado por:  Franco Alessandro Arenas Mamani Elisvan Chumbislla Sullca Jhon Diego Apucusi Mamani kait Fatima Lupo Ziabala | CUI: 20191977 20260171 20260168 20260180 |
| --- | --- |



LUGAR: Escuela Profesional de Ingeniería Pesquera, 101


FECHA: 08 de Mayo del 2026


Título: Análisis físico del sistema de izaje en embarcaciones de cerco: Relación entre Tensión, Torque y Potencia durante la extracción de captura


1. Introducción y Contexto


El Perú es uno de los líderes mundiales en la extracción de recursos hidrobiológicos, destinando la gran mayoría de la captura de anchoveta a la producción de harina y aceite de pescado (Organización de las Naciones Unidas para la Alimentación y la Agricultura [FAO], 2022). En este contexto de extracción a gran escala, la operatividad a bordo de las embarcaciones pesqueras depende de sistemas mecánicos robustos. La extracción no es solo un proceso biológico, sino un desafío que obedece a las leyes de la mecánica clásica: levantar toneladas de biomasa y agua desde el mar requiere la aplicación precisa de fuerzas, tensiones y el uso de máquinas simples (García et al., 2019). El presente trabajo analiza desde la perspectiva de la física el sistema de izaje (winche y poleas) utilizado en embarcaciones de cerco.
...
Para resolver este problema de ingeniería pesquera, aplicaremos los principios fundamentales de la mecánica vectorial, dinámica de partículas, fluidos y oscilaciones de manera estructurada:

![Esquema de Fuerzas, Torque y Tensión en el Tambor del Winche](extracted_media/TIF%20F%C3%ADsica%20-%20An%C3%A1lisis%20Winche%20Pesquero/image3.png)
*Figura 1: Esquema de fuerzas dinámicas en el tambor de arrollamiento (Tensión F, velocidad angular $\omega$, torque $Mt$ y diámetro del tambor).*
...
*   **Vector Fricción Hidrodinámica ($\vec{F}_d$):** Resistencia del fluido que se opone al movimiento de la red. Actúa en sentido contrario a la velocidad relativa:
    $$\vec{F}_d = -Fd \cdot \text{sgn}(v_{\text{rel}}) \hat{j}$$
...
![Modelado 3D del Ensamble General del Winche Pesquero](extracted_media/TIF%20F%C3%ADsica%20-%20An%C3%A1lisis%20Winche%20Pesquero/image1.png)
*Figura 2: Ensamble tridimensional general del winche pesquero modelado en Autodesk Inventor (archivo winche_ensamble.iam).*

![Diseño CAD del Tambor de Enrollamiento](extracted_media/TIF%20F%C3%ADsica%20-%20An%C3%A1lisis%20Winche%20Pesquero/image2.png)
*Figura 3: Modelo del tambor de arrollamiento de cables (archivo tambor.ipt), diseñado para soportar las presiones radiales del cable de acero.*

![Diseño CAD del Eje de Transmisión](extracted_media/TIF%20F%C3%ADsica%20-%20An%C3%A1lisis%20Winche%20Pesquero/image4.png)
*Figura 4: Eje central de transmisión de torque (archivo eje.ipt), dimensionado para resistir esfuerzos combinados de torsión y flexión.*

---

### 4.3. Simulador Interactivo de Cubierta (HTML/JS)
Como parte del desarrollo tecnológico del proyecto, hemos construido un simulador interactivo en tiempo real accesible localmente en [Simulador de Cubierta (Bonito)](file:///F:/ING%20PESQUERA/FISICA/TIF%20UNIDAD%202/simulacion/index.html). 
